...
export const metadata: Metadata = {
  ...
  keywords: ["FLYTHEBG", "FlytheBG", "Fly the BG", "flythebg.com", "free background remover", "remove background online", "local AI background remover", "private background remover", "transparent PNG maker", "passport photo maker", "passport size photo maker", "browser background remover"],
      ...
      <section className="cinematicHero">
        ...
        <div className="cinematicHeroLayer">
          <nav className="cinematicNav" aria-label="FLYTHEBG tools">
            ...
            <div className="cinematicTabs"><Link className="cinematicHomeRemoveBg" href="/remove-background">Remove BG</Link><Link href="/features">Features</Link><Link className="cinematicHomePassport" href="/features/passport-photo">Passport</Link><Link className="cinematicHomeFaq" href="/faq">FAQ</Link><Link className="cinematicHomeSecurity" href="/privacy">Security</Link><Link className="cinematicHomeAbout" href="/about">About</Link></div>
          </nav>
          <div className="landingHeroAd" aria-label="Top advertisement placement"><AdPlaceholder slot="landing-inline-1" format="leaderboard" /></div>
          <section className="cinematicHeroContent" aria-labelledby="flythebg-hero-title">
            ...
            <div className="cinematicHeroActions"><Link className="cinematicCta" href="/features"><span className="cinematicCtaLabel">See features</span><span className="cinematicCtaArrow" aria-hidden="true">→</span></Link><a className="cinematicCta cinematicSupportCta" href={SUPPORT_URL} target="_blank" rel="noopener noreferrer"><span className="cinematicCtaLabel">📖 Support FlytheBG</span><span className="cinematicCtaArrow" aria-hidden="true">↗</span></a></div>
