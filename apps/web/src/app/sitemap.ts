...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    { path: "/guides", priority: .85, changeFrequency: "monthly" as const },
    { path: "/guides/background-removal", priority: .82, changeFrequency: "monthly" as const },
    { path: "/guides/passport-photo", priority: .82, changeFrequency: "monthly" as const },
    { path: "/guides/browser-privacy", priority: .82, changeFrequency: "monthly" as const },
