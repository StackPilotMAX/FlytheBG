...
const guides = [
  {
    ...
    text: "Learn which source photos are easiest to segment, why the first browser run can be slower, how FlytheBG validates a cutout, and what to try when edges are difficult.",
  },
  {
  ...
  },
  {
    ...
    text: "See what stays on the device, which IMG.LY software assets are downloaded, what FlytheBG clears after download, and which browser or operating-system copies remain outside the page's control.",
  },
];
    ...
    <main className="featurePage">
      <section className="pageHero">
        <div className="shell narrowHero">
          ...
          <p>These guides explain the real workflow behind FlytheBG's live tools. They are written for people preparing images, not as filler around ads.</p>
        </div>
      </section>
      ...
      <section className="section workflowSection">
        <div className="shell workflowGrid">
          <div className="sectionHeading compact">
            ...
            <p>FlytheBG explains its own tools and general image-production principles. For passports, visas, IDs, licences, schools, employers, or other regulated uses, always verify the current specification from the authority that will receive the photo.</p>
          </div>
          <div className="principleList">
            <article><strong>Tool-specific</strong><p>The guides describe how FlytheBG actually processes, frames, exports, and clears working images.</p></article>
