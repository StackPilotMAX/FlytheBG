...
export default function PrivacyPage() {
  return <LegalPage title="Privacy & AI Policy" updated="18 August 2026">
    ...
    <p>Background removal uses the IMG.LY browser package. FlytheBG first tries the quantized IS-Net browser model and automatically retries the FP16 variant if the first model fails or produces an unusable cutout. The source image is passed to the browser package on the visitor&apos;s device.</p>
    ...
    <p>FlytheBG validates supported file types and sizes in the browser and limits large passport-sheet canvases to reduce crashes and memory exhaustion. No website or browser environment can guarantee absolute security or uninterrupted availability.</p>
