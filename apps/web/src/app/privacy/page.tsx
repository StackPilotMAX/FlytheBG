...
export default function PrivacyPage() {
  return <LegalPage title="Privacy & AI Policy" updated="17 August 2026">
    ...
    <p>If you choose the direct-photo option, framing, sheet layout, physical-size conversion, background-color compositing, and PNG generation occur in the browser. If you choose “Remove background first”, FlytheBG Precision processes the image before the browser creates the print sheet. The cutout is validated before sheet creation so a near-empty transparent result is rejected instead of silently producing a color-only sheet.</p>
    <p>Print-sheet previews and generated sheets are not intentionally stored in the application database. The download flow releases the working source, cutout, preview canvases, and generated sheet from the FlytheBG tab after the browser download starts.</p>
