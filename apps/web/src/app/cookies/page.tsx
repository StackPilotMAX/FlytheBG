...
export default function CookiesPage() {
  return <LegalPage title="Cookie & Local Storage Policy" updated="16 August 2026">
    ...
    <p>FlytheBG&apos;s core background-removal, cropping, and passport-photo tools do not depend on advertising cookies to perform the image-editing task. The permanent galaxy and image editors run in the browser independently of advertising preferences.</p>
