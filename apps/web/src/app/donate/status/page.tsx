...
export const metadata: Metadata = {
  title: "Support Verification · FlytheBG",
  description: "Secure verification information for FlytheBG book-support payments.",
    ...
    <main className="donatePage">
      <div className="donateShell">
        <section className="donateHero">
          <span className="donateEyebrow">Support verification</span>
        ...
        <section className="donateCard" style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <div className="donateSteps">
            <div className="donateStep"><div><h3>Pending</h3><p>The book-support payment may still be processing, or Buy Me a Coffee has not delivered the confirmation event yet.</p></div></div>
            ...
            <div className="donateStep"><div><h3>Refunded</h3><p>A valid <code>donation.refunded</code> event changes the stored support state so the site does not continue treating a refunded contribution as active.</p></div></div>
          </div>
          ...
          <Link className="donateReturn" href="/donate">← Back to Buy Me a Book</Link>
        </section>
      </div>
    </main>
  );
